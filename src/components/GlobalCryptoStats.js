const GlobalCryptoStats = () => {
  return (
    <div className="">
      <p className="text-4xl font-semibold text-black pb-4">Global Crypto Stats</p>
      
      <div className="grid grid-cols-2 grid-rows-3 place-content-between gap-x-96 gap-y-8">
